  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("company", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("company", "update")?config.routes.edit:false}
        // showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("company", "delete"), deleteRecord }}
        action={(getPermissions("company", "delete")||getPermissions("company", "update"))||false}

        generalCols={generateCols(["name_en",
        "name_ar",
         "due_day_on_month",
          "stage"])}
