                ...
                <Row>
                  <Col span={24}>
                    ...
                    >
                      ...
                      <Form.Item
                        label={<IntlMessages id="due_day_on_month" />}
                        hasFeedback
                      >
                        {getFieldDecorator("due_day_on_month", {
                          initialValue: cat ? cat.due_day_on_month : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="due_day_on_month" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
                      ...
                      <Form.Item
                        label={<IntlMessages id="stage" />}
                        hasFeedback
                      >
                        {getFieldDecorator("stage", {
                          initialValue: cat ? cat.stage : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="stage" />,
                            },
                          ],
                        })(                      <Select
