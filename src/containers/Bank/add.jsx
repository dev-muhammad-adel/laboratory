                ...
                <Row>
                  <Col span={24}>
                    ...
                    >
                      ...
                      <Form.Item
                        label={<IntlMessages id="bank_code" />}
                        hasFeedback
                      >
                        {getFieldDecorator("bank_code", {
                          initialValue: cat ? cat.bank_code : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="bank_code" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
                      <Form.Item
                        label={<IntlMessages id="clearing_code" />}
                        hasFeedback
                      >
                        {getFieldDecorator("clearing_code", {
                          initialValue: cat ? cat.clearing_code : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="clearing_code" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
