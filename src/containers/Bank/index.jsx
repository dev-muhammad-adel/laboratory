  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("bank", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("bank", "update")?config.routes.edit:false}
        // showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("bank", "delete"), deleteRecord }}
        action={(getPermissions("bank", "delete")||getPermissions("bank", "update"))||false}

        generalCols={generateCols(["name_en","name_ar", "bank_code", "clearing_code"])}
