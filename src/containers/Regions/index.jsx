  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("area", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("area", "update")?config.routes.edit:false}
        //   showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("area", "delete"), deleteRecord }}
        action={(getPermissions("area", "delete")||getPermissions("area", "update"))||false}
        generalCols={generateCols(["name_en", "name_ar", "city_name", 
        {
          key: "Country",
        ...
        {
          key: "City",
          content: (text, record) =><Tag color="cyan">{ record.city.name_en } - { record.city.name_ar}</Tag>  
        },
        {
          key: "created_at",
          content: (text, record) =>
