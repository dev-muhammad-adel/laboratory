                ...
                <Row>
                  <Col span={24}>
                    ...
                    >
                      ...
                      <Form.Item
                        label={<IntlMessages id="body_en" />}
                        hasFeedback
                      >
                        {getFieldDecorator("body_en", {
                          initialValue: cat ? cat.body_en : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="body_en" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
                      <Form.Item
                        label={<IntlMessages id="body_ar" />}
                        hasFeedback
                      >
                        {getFieldDecorator("body_ar", {
                          initialValue: cat ? cat.body_ar : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="body_ar" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
