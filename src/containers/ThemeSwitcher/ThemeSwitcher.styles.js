...
const ThemeSwitcherStyle = styled.div`
  ...
  position: fixed;
  top: 120px;
  right: ${(props) => (props["data-rtl"] === "rtl" ? "inherit" : "-280px")};
  left: ${(props) => (props["data-rtl"] === "rtl" ? "-280px" : "inherit")};
  z-index: 1001;
  ${transition()};
  ...
  border-radius: ${(props) =>
    props["data-rtl"] === "rtl" ? "0 8px 8px 0" : "8px 0 0 8px"};
  .componentTitleWrapper {
    padding: 15px 15px;
    background-color: ${palette("text", 0)};
    border-radius: ${(props) =>
      props["data-rtl"] === "rtl" ? "0 8px 0px 0" : "8px 0 0"};
    .componentTitle {
      font-size: 21px;
      font-family: cursive;
