  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("occupation", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("occupation", "update")?config.routes.edit:false}
        // showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("occupation", "delete"), deleteRecord }}
        action={(getPermissions("occupation", "delete")||getPermissions("occupation", "update"))||false}
