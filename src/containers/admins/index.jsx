  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("user", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("user", "update")?config.routes.edit:false}
         showRowURL={!getPermissions("user", "update")?config.routes.show:false}
         deleteRow={{ status: getPermissions("user", "delete"), deleteRecord }}
        action={(getPermissions("user", "delete")||getPermissions("user", "update"))||true}
