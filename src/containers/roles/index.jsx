  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("role", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("role", "update")?config.routes.edit:false}
        //   showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("role", "delete"), deleteRecord }}
        action={(getPermissions("role", "delete")||getPermissions("role", "update"))||false}
